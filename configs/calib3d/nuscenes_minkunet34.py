...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/data/sets/nuscenes/nuscenes_infos_train.pkl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/data/sets/nuscenes/nuscenes_infos_val.pkl',
        data_prefix=data_prefix,
...
val_evaluator = [
    dict(type='SegMetric'),
    dict(type='ECEMetric', file_name='nuscenes_minkunet34.pkl'),
]
